...
Each detailed endpoint follows this frontend-focused structure:
...
8. Edge Cases: User-facing validation/authorization errors.
9. Example Request:
    curl -X GET "{{baseUrl}}/"
